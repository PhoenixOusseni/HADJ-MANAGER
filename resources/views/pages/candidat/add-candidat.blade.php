                        ...
                        <div class="sbp-preview-content">
                            <form method="POST" action="">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="passport" type="number" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Lieu naissance</label>
                                            <input class="form-control" name="montant" type="text" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">CNIB / Passport</label>
                                            <input class="form-control" name="montant" type="text" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Date délivrance</label>
                                            <input class="form-control" name="date_deliv" type="date" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Date d'expiration</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Nationalité</label>
                                            <input class="form-control" name="montant" type="text" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Ville / Province</label>
                                            <input class="form-control" name="montant" type="text" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Service lié</label>
                                            <select class="form-select" name="sexe">
                                                <option value="Hadj 2024">Hadj 2024</option>
                                                <option value="Hadj 2025">Hadj 2025</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            <label class="small">Facilitateur</label>
                                            <select class="form-select" name="sexe">
                                                <option value="Hadj 2024">OUEDRAOGO Ousseni</option>
                                                <option value="Hadj 2025">YABRE Lassané</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
