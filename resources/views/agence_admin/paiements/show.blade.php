            ...
            <div class="card shadow" style="border-radius: 5px;">
                <div class="card-body">
                    ...
                    <div class="m-t-15 btn-showcase">
                        @can('view', $paiement->candidat)
                        <a href="{{ route('adm_agc_candidats.show', $paiement->candidat->id) }}" class="btn btn-square btn-info m-1"><i class="fa-solid fa-eye me-2"></i>Voir le candidat</a>
                        @endcan
                        @can('update', $paiement)
