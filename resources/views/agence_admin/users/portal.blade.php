        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header card-no-border pb-0">
                    ...
                    <p class="mt-1 mb-0">Cette liste vous permet de selectionner le service pour ajouter un adminisatreur</p>
                </div>
                <div class="card-body grid-showcase">
                    <div class="row">
                        @foreach ($services as $service)
                        <div class="col-md-3 text-center"><a href="{{ route('adm_agc_users.form', $service->id) }}"><span>{{ $service->libelle ?? '' }}</span></a></div>
                        @endforeach
                    </div>
                </div>
            </div>
