                ...
                <div class="card shadow" style="border-radius: 5px;">
                    <div class="card-body">
                                                ...
                                                <td>
                                                    @if ($candidat->photo)
                                                        <img src="{{ asset('candidat/photo/' . $candidat->photo) }}"
                                                            alt="Photo"
                                                            style="height:100px; width:100px; object-fit:cover; border-radius:10px; margin-bottom: 15px;">
                                                    @else
                                                        <img src="{{ asset('main/assets/images/avatars/1.png') }}"
                                                            alt="Photo"
                                                            style="height:100px; width:100px; object-fit:cover; border-radius:10px; margin-bottom: 15px; background: #ccc;">
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="m-t-15 btn-showcase">
                            ...
                            @endcan
                            @can('delete', $candidat)
                                <form action="{{ route('adm_agc_candidats.destroy', $candidat->id) }}" method="POST"
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card shadow" style="border-radius: 5px;">
                    <div class="card-body">
                        <a href="#" class="btn btn-outline-primary-2x" data-bs-toggle="modal"
                            data-bs-target="#addDipBackdrop"><i class="fa-solid fa-plus"></i>&thinsp;&thinsp;&thinsp; Ajouter
                            un paiement</a>
                            <a href="#" class="btn btn-outline-warning-2x" data-bs-toggle="modal"
                            data-bs-target="#addDipBackdrop"><i class="fa-solid fa-eye"></i>&thinsp;&thinsp;&thinsp; Historique des paiements</a>
                                ...
                                <tbody>
                                    @foreach ($paiements as $paiement)
                                        <tr>
                                            ...
                                            <td>
                                                @can('view', $paiement)
                                                    <a href="{{ route('adm_agc_paiements.show', $paiement->id) }}"
                                                        class="btn btn-square btn-info m-1"><i class="fa-solid fa-eye"></i></a>
                                                @endcan
                                                @can('update', $paiement)
                                                    <a href="{{ route('adm_agc_paiements.edit', $paiement->id) }}"
                                                        class="btn btn-square btn-warning m-1"><i
                                                            class="fa-solid fa-edit"></i></a>
                                                @endcan
                                                @can('delete', $paiement)
                                                    <form action="{{ route('adm_agc_paiements.destroy', $paiement->id) }}"
                                                        method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-square btn-danger m-1"
                                                            onclick="return confirm('Supprimer ce paiement ?')"><i
                                                                class="fa-solid fa-trash"></i></button>
                                                    </form>
                                                @endcan
                                            </td>
