...
<div class="container-fluid default-dashboard">
    <div class="row">
        <div class="col-xxl-12 col-xl-12 proorder-xxl-12 col-lg-12 box-col-12">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 shadow shadow-md-1 rounded-3">
                <div class="card job-card shadow-sm" style="border-radius: 5px;">
                    ...
                    <div class="card-body pt-2">
                        <div class="card-img">
                            <img src="{{ asset('asset/undraw_winter-designer_a6kq.png') }}" class="card-img-top" alt="service" style="width: 100%; height: auto;">
                        </div>
