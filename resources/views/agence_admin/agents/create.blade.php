                ...
                <div class="col-sm-6 col-12">
                    <ol class="breadcrumb">
                        ...
                        @can('viewAny', App\Models\Agent::class)
                            <li class="mx-2"><a href="{{ route('adm_agc_agents.index') }}"><i
                                        class="fa-solid fa-list"></i></a></li>
                        @endcan
                        @can('create', App\Models\Agent::class)
                            <li class="">/</li>
                            <li class="mx-2 active"><a href="{{ route('adm_agc_agents.create') }}"><i
                ...
                <div class="card">
                    ...
                    <div class="card-body basic-form">
                        ...
                        <form action="{{ route('adm_agc_agents.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="tel" name="residence"
                                    placeholder="Ex : 123 rue Zogona" value="{{ old('residence') }}">
                                @error('residence')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
