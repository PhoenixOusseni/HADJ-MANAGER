                    ...
                    <div class="btn-showcase">
                        @can('update', $service)
                            <a href="{{ route('adm_agc_services.edit', $service->id) }}"
                                class="btn btn-square btn-warning m-1"><i class="fa-solid fa-edit"></i>&thinsp;&thinsp;
                                Modifier</a>
                        @endcan
                        @can('delete', $service)
                            <form action="{{ route('adm_agc_services.destroy', $service->id) }}" method="POST"
                                ...
                                <button type="submit" class="btn btn-square btn-danger m-1"
                                    onclick="return confirm('Supprimer ce service ?')"><i
                                        class="fa-solid fa-trash"></i>&thinsp;&thinsp; Supprimer</button>
                            </form>
                        @endcan
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('adm_agc_agents.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-sm-3">
                        <label class="form-label small">Résidence</label>
                    </div>
                    <div class="col-sm-9">
                    ...
                    <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="sexe">
                                            ...
                                            <option value="Masculin"
                                                {{ old('sexe') == 'Masculin' ? 'selected' : '' }}>Masculin</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Type de pièce <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control" name="type_piece">
                                            <option value="">Sélectionner ici</option>
                                            <option value="CNIB"
                                                {{ old('type_piece') == 'CNIB' ? 'selected' : '' }}>CNIB</option>
                                            <option value="Passeport"
                                                {{ old('type_piece') == 'Passeport' ? 'selected' : '' }}>Passeport
                                            </option>
                                        </select>
                                        @error('type_piece')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="statut">
                                            <option value="">Sélectionner ici</option>
                                            <option value="Provisoir"
                                                {{ old('statut') == 'Provisoir' ? 'selected' : '' }}>Provisoire
                                            </option>
                                            <option value="Définitif"
                                                {{ old('statut') == 'Définitif' ? 'selected' : '' }}>Définitif</option>
                                        </select>
                                        @error('statut')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="statut_paiement">
                                            ...
                                            <option value="Non payé"
                                                {{ old('statut_paiement') == 'Non payé' ? 'selected' : '' }}>Non payé
                                            </option>
                                            <option value="Paiement partiel"
                                                {{ old('statut_paiement') == 'Paiement partiel' ? 'selected' : '' }}>
                                                Paiement partiel</option>
                                            <option value="Tout payé"
                                                {{ old('statut_paiement') == 'Tout payé' ? 'selected' : '' }}>Tout payé
                                            </option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Agent facilitateurl</label>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" value="{{ $service->libelle }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('adm_agc_paiements.store') }}" method="POST" class="theme-form row g-3">
                        ...
                        <select class="form-select" name="candidat_id" required>
                            ...
                            @foreach ($candidats as $candidat)
                                <option value="{{ $candidat->id }}"
                                    {{ old('candidat_id') == $candidat->id ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="number" name="montant" step="0.01"
                            placeholder="Entrez le montant payé" value="{{ old('montant') }}" required>
                        @error('montant')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-sm-9">
                        <select class="form-select" name="mode_paiement">
                            ...
                            <option value="Orange Money"
                                {{ old('mode_paiement') == 'Orange Money' ? 'selected' : '' }}>Orange Money</option>
                        </select>
                        @error('mode_paiement')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Compagnie</label>
                                        <input class="form-control" type="text" name="compagnie"
                                            placeholder="Entrez le nom de la compagnie"
                                            value="{{ old('compagnie') }}" required>
                                        @error('compagnie')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Type de vol</label>
                                        <select class="form-select" name="type_vol">
                                            <option value="">Sélectionner ici</option>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Trajet</label>
                                        <select class="form-control" name="trajet">
                                            <option value="">Sélectionner ici</option>
                                            <option value="Aller simple"
                                                {{ old('trajet') == 'Aller' ? 'selected' : '' }}>Aller</option>
                                            <option value="Aller-retour"
                                                {{ old('trajet') == 'Aller-retour' ? 'selected' : '' }}>Aller-retour
                                            </option>
                                            <option value="Retour" {{ old('trajet') == 'Retour' ? 'selected' : '' }}>
                                                Retour</option>
                                        </select>
                                        @error('trajet')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Numéro de vol</label>
                                        <input class="form-control" type="text" name="numero_vol"
                                            placeholder="Ex : AF123" value="{{ old('numero_vol') }}" required>
                                        @error('numero_vol')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Ville de départ (Aller)</label>
                                        <input class="form-control" type="text" name="ville_depart_aller"
                                            placeholder="Ville de départ" value="{{ old('ville_depart_aller') }}"
                                            required>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Ville d’arrivée (Aller)</label>
                                        <input class="form-control" type="text" name="ville_arrivee_aller"
                                            placeholder="Ville d’arrivée" value="{{ old('ville_arrivee_aller') }}"
                                            required>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Date & heure de départ (Aller)</label>
                                        <input class="form-control" type="datetime-local"
                                            name="date_heure_depart_aller"
                                            value="{{ old('date_heure_depart_aller') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Date & heure d’arrivée (Aller)</label>
                                        <input class="form-control" type="datetime-local"
                                            name="date_heure_arrivee_aller"
                                            value="{{ old('date_heure_arrivee_aller') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Ville de départ (Retour)</label>
                                        <input class="form-control" type="text" name="ville_depart_retour"
                                            placeholder="Ville de départ (retour)"
                                            value="{{ old('ville_depart_retour') }}">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Ville d’arrivée (Retour)</label>
                                        <input class="form-control" type="text" name="ville_arrivee_retour"
                                            placeholder="Ville d’arrivée (retour)"
                                            value="{{ old('ville_arrivee_retour') }}">
                                        @error('ville_depart_retour')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Date & heure de départ (Retour)</label>
                                        <input class="form-control" type="datetime-local"
                                            name="date_heure_depart_retour"
                                            value="{{ old('date_heure_depart_retour') }}">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Date & heure d’arrivée (Retour)</label>
                                        <input class="form-control" type="datetime-local"
                                            name="date_heure_arrivee_retour"
                                            value="{{ old('date_heure_arrivee_retour') }}">
                                ...
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" name="quota"
                                            placeholder="Nombre de places disponibles" value="{{ old('quota') }}"
                                            required>
                                        @error('quota')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Convocation</label>
                                        <input class="form-control" type="text" name="convocation"
                                            placeholder="Lieu ou heure de convocation"
                                            value="{{ old('convocation') }}">
                                        @error('convocation')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="nom"
                                            placeholder="Entrez le nom de l'hôtel" value="{{ old('nom') }}"
                                            required>
                                        @error('nom')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="ville"
                                            placeholder="Entrez la ville" value="{{ old('ville') }}">
                                        @error('ville')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="quartier"
                                            placeholder="Entrez le quartier" value="{{ old('quartier') }}">
                                        @error('quartier')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Téléphone</label>
                                        <input class="form-control" type="text" name="telephone"
                                            placeholder="Ex. : +226 70 00 00 00" value="{{ old('telephone') }}">
                                        @error('telephone')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Contact du responsable</label>
                                        <input class="form-control" type="text" name="contact_responsable"
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Début d'activité</label>
                                        <input class="form-control" type="date" name="debut"
                                            placeholder="Date de début" value="{{ old('debut') }}">
                                        @error('debut')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Fin d'activité</label>
                                        <input class="form-control" type="date" name="fin"
                                            placeholder="Date de fin" value="{{ old('fin') }}">
                                        @error('fin')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Nombre de chambres</label>
                                        <input class="form-control" type="number" name="nombre_chambre"
                                            placeholder="Ex. : 50" value="{{ old('nombre_chambre') }}">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="mb-3">
                                        <label class="form-label small">Nombre de lits</label>
                                        <input class="form-control" type="number" name="nombre_lit"
                                            placeholder="Ex. : 120" value="{{ old('nombre_lit') }}">
                                        @error('nombre_lit')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
