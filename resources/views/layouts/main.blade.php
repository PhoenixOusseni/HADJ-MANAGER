...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <header class="page-header row">
            <div class="logo-wrapper d-flex align-items-center col-auto"><a href="{{ route('home') }}"><img class="light-logo img-fluid" src="{{ asset('main/assets/images/logo/1.png')}}" alt="logo" /><img class="dark-logo img-fluid" src="{{ asset('main/assets/images/logo/2.png')}}" alt="logo" /></a><a class="close-btn toggle-sidebar" href="javascript:void(0)">
                        ...
                        <li class="profile-nav custom-dropdown">
                            ...
                            <div class="custom-menu overflow-hidden">
                                <ul class="profile-body">
                                    <li class="d-flex">
                                        <i class="fa-solid fa-user"></i><a class="ms-2" href="{{ route('admin.profil', auth()->user()->id) }}">Mon compte</a>
                                    </li>
                                    <li class="d-flex">
