        ...
        <div class="col-md-12">
            <div class="card shadow" style="border-radius: 5px;">
                ...
                <div class="card-body basic-form">
                    ...
                    <form action="{{ route('agents.update', $agent->id) }}" method="POST" enctype="multipart/form-data" class="theme-form row g-3">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-sm-9">
                            <select class="form-control @error('agence_id') is-invalid @enderror" name="agence_id">
                                ...
                                <option value="{{ $agence->id }}" {{ old('service_id', $agent->agence_id) == $agence->id ? 'selected' : '' }}>
                                    {{ $agence->libelle }}
                                </option>
                                @endforeach
                            </select>
