        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body basic-form">
                    ...
                    <form action="{{ route('agents.store') }}" method="POST" enctype="multipart/form-data" class="theme-form row g-3">
                        @csrf
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="statut">
                                ...
                                <option value="Facilitateur" {{ old('statut') == 'Facilitateur' ? 'selected' : '' }}>Facilitateur</option>
                                <option value="Délégué" {{ old('statut') == 'Délégué' ? 'selected' : '' }}>Délégué</option>
                            </select>
                            @error('statut')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
