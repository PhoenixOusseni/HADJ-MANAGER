        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header card-no-border pb-0">
                    ...
                    <p class="mt-1 mt-1 mb-0">Cette liste vous permet de selectionner l'agence que vous voulez ajouter les hotels </p>
                </div>
                <div class="card-body grid-showcase">
                    <div class="row">
                        @foreach ($agences as $agence)
                        <div class="col-md-3 text-center"><a href="{{ route('hotels.form', $agence->id) }}"><span>{{ $agence->libelle ?? '' }}</span></a></div>
                        @endforeach
                    </div>
                </div>
            </div>
